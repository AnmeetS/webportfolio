...
import WEAccelerate from "./workinfo/WEAccelerate"
import { motion } from "framer-motion"

const Experience = () => {
    const [workWEAccelerate, setworkWEAccelerate] = React.useState(true);
    const [workInqsys, setworkInqsys] = React.useState(false);
    const [workFRCwork, setworkFRCwork] = React.useState(false);
    const [workWebpulse, setworkWebpulse] = React.useState(false);
    
    const handleWEAccelerate = () => {
        setworkWEAccelerate(true);
        setworkInqsys(false);
