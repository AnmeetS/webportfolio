            ...
            <div className="relative flex flex-col gap-4 pb-4">
              ...
              <div className="flex flex-col gap-2 text-copyLighter px-2">
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <p>
                    If you see something of yours that I didnt credit I
                    apologize in advance. Just send me an email and I&apos;ll
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <p>
                    If you&apos;re still reading this, please lmk if you have
                    any feedback for the website :D
                  </p>
                </div>
              </div>
              <button
